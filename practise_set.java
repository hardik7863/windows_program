//
import java.util.*;//pending hai

public class practise_set {

  //Q1.wap to print table of number n?
    static void multiplication(int a){
      for (int i = 1; i <=10; i++) {
        System.out.format("%d*%d=%d\n",a,i,a*i);
      }
    }
    //Q2.wap to print the pattern given below?
    // *
    // **
    // ***
    // ****
  ...
  //Q3.wap to print sum of n natural number using recursion?
